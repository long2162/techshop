...
VALUES
  ('CAT000001', 'Máy lạnh', 'may_lanh.png'),
  ('CAT000002', 'Máy giặt', 'may_giat.png'),
  ('CAT000003', 'Tivi', 'tivi.png'),
  ('CAT000004', 'Điện thoại', 'dien_thoai.png'),
  ('CAT000005', 'Laptop', 'laptop.png'),
  ('CAT000006', 'Tablet', 'tablet.png'),
  ('CAT000007', 'Tủ lạnh', 'tu_lanh.png'),
  ('CAT000008', 'Nồi cơm', 'noi_com.png'),
  ('CAT000009', 'Nồi chiên', 'noi_chien.png'),
  ('CAT000010', 'Bếp điện', 'bep_dien.png');
...
-- Bảng Images
INSERT INTO product_imgs (image_id, product_id, image_name, image_is_display)
VALUES 
...
VALUES
('U00000001', '0987654321', '123456', 'Nguyễn Văn An', '1990-01-01', 'Nam', 'user1@example.com', '0987654321', 'Kiên Giang', 1),
('U00000002', '0987654322', '123456', 'Trần Thị Bình', '1991-02-02', 'Nữ', 'user2@example.com', '0987654322', 'TP. Hồ Chí Minh', 1),
('U00000003', '0976251470', '123123123', 'Nguyễn Đức Long', '2000-06-06', 'Nam', 'user3@example.com', '0976251470', 'Hà Nội', 1),
('U00000004', '0987654324', '123456', 'Trương Quang Phú', '1990-01-01', 'Nam', 'user4@example.com', '0987654324', 'Hải Dương', 1),
('U00000005', '0987654325', '123456', 'Trần Thiên Lọc', '1990-01-01', 'Nam', 'user5@example.com', '0987654325', 'Hà Nội', 1),
('U00000006', '0987654326', '123456', 'Nguyễn Phú Cường', '1999-03-03', 'Nam', 'user6@example.com', '0987654326', 'Đà Nẵng', 1),
('U00000007', '0987654327', '123456', 'Phan Thanh Danh', '1999-03-03', 'Nữ', 'user7@example.com', '0987654327', 'Đồng Nai', 1),
('U00000008', '0987654328', '123456', 'Mai Văn Tiên', '1999-03-03', 'Nam', 'user8@example.com', '0987654328', 'Đà Nẵng', 1),
('U00000009', '0987654329', '123456', 'Tô Thanh Lộc', '1999-03-03', 'Nam', 'user9@example.com', '0987654329', 'Bình Phước', 1),
('U00000010', '0987654330', '123456', 'Nguyễn Nhựt Tiến', '1999-03-03', 'Nữ', 'user10@example.com', '0987654330', 'Cần Thơ', 1),
('U00000011', '0987654331', '123456', 'Lý Văn Nghĩa', '1999-03-03', 'Nam', 'user11@example.com', '0987654331', 'Huế', 1),
('U00000012', '0987654332', '123456', 'Hồ Thị Mai', '1999-03-03', 'Nữ', 'user12@example.com', '0987654332', 'Bình Dương', 1),
('U00000013', '0987654333', '123456', 'Lê Bích Tuyền', '1999-03-03', 'Nữ', 'user13@example.com', '0987654333', 'Bình Dương', 1),
('U00000014', '0987654334', '123456', 'Lê Hồng Bảo Trinh', '1999-03-03', 'Nam', 'user14@example.com', '0987654334', 'Bình Dương', 1),
('U00000015', '0987654335', '123456', 'Nguyễn Hoàng PHương Linh', '1999-03-03', 'Nữ', 'user15@example.com', '0987654335', 'Bình Dương', 1);
...
-- Bảng carts
INSERT INTO carts (customer_id, product_variant_id, cart_quantity)
VALUES
...
-- Bảng orders
INSERT INTO orders (order_id, customer_id, staff_id, order_name, order_phone, order_date, order_delivery_date, order_delivery_address, order_note, order_total_before, order_total_after, paying_method_id, order_paying_date, order_is_paid, order_status)
VALUES 
  ('O00000001', 'CUS000001', 'STF000001', 'Nguyễn Văn An', '0987654321', '2025-11-02', '2025-11-04', '123 Nguyen Trai, Thanh Xuan, Ha Noi', 'Kiểm hàng trước', 6990000, 6290000, 'PMETHOD02', '2025-11-02', 1, 'Đang giao hàng'),
  ('O00000002', 'CUS000002', 'STF000002', 'Nguyễn Đức Long', '0987654321', '2025-11-02', '2025-11-04', '123 Nguyen Trai, Thanh Xuan, Ha Noi', 'Kiểm hàng trước', 6990000, 6290000, 'PMETHOD01', '2025-11-02', 1, 'Đang giao hàng'),
  ('O00000003', 'CUS000003', 'STF000003', 'Nguyễn Văn An', '0987654321', '2025-11-02', '2025-11-04', '123 Nguyen Trai, Thanh Xuan, Ha Noi', 'Kiểm hàng trước', 6990000, 6290000, 'PMETHOD03', '2025-11-02', 1, 'Đang giao hàng');

 
-- Bảng orders_details
INSERT INTO order_details (order_id, product_variant_id, order_detail_quantity, order_detail_price_before,  order_detail_price_after)
VALUES
  ('O00000001', 'PRO001000', 1, 6990000, 6990000),
  ('O00000002', 'PRO001000', 2, 6990000, 6990000),
  ('O00000003', 'PRO002000', 2, 6990000, 6990000);
...
INSERT INTO notification_types (notification_type_id, notification_type_name, notification_type_img)
VALUES
  ('NTTYPE001', 'Order placed', 'order_placed.png'),
  ('NTTYPE002', 'Order shipped', 'order_shipped.png'),
  ('NTTYPE003', 'Order delivered', 'order_delivered.png'),
  ('NTTYPE004', 'Payment received', 'payment_received.png'),
  ('NTTYPE005', 'Feedback received', 'feedback_received.png'),
  ('NTTYPE006', 'Sale', 'sale.png'),
  ('NTTYPE007', 'Lucky Customer', 'lucky_customer.png');

-- Bảng notifications
INSERT INTO notifications (notification_id, notification_type_id, notification_title, notification_subtitle, notification_content, notification_date, notification_is_display)
VALUES
...
INSERT INTO user_notification (user_id, notification_id, user_notification_is_read)
VALUES
